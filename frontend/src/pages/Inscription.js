  ...
  const soumettre = async () => {
    ...
    try {
      const url = mode === 'inscription'
        ? `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/api/auth/inscription`
        : `${process.env.REACT_APP_API_URL || 'http://localhost:5000'}/api/auth/connexion`;
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '440px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ color: '#fff', fontSize: '26px', fontWeight: '700', letterSpacing: '-0.5px' }}>
            TCF<span style={{ color: '#1D9E75' }}>Pro</span> Canada
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.55)', fontSize: '14px', marginTop: '6px' }}>
            Préparez votre TCF Canada avec l'intelligence artificielle
          </p>
        </div>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '10px', cursor: chargement ? 'default' : 'pointer',
